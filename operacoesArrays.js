...
var listaDeCompras = ["Maçã", " Fósforo", " Agua", " Peito de frango", " Feijão", " Arroz"];
console.log(`A lista atualmente é: ${listaDeCompras}`);

console.log(`O quarto elemento da lista é: ${listaDeCompras[3]}`);

listaDeCompras[0] = " Pêra";

var esquecidos = [" Papel higiênico", " Suco de laranja"];

let listaCompleta = listaDeCompras.concat(esquecidos);

listaCompleta.push(" Sabonete");

console.log(`A lista completa atualmente é: ${listaCompleta}`);

console.log(`O arroz está  na posição: ${listaCompleta.indexOf(" Arroz")}`);

console.log(`A lista em ordem alfabética é: ${listaCompleta.sort()}`);

listaBackup = listaCompleta.slice(0, 7);
console.log(`A lista backup de joão é: ${listaBackup}`);

console.log(`Todos os itens foram comprados, a lista agora é: ${listaCompleta.length = 0}`);
